...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__relokate

#else
#  define SWIG_init    init_relokate

#endif
#define SWIG_name    "_relokate"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_res2center(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "res2center", 7, 7, swig_obj)) SWIG_fail;
  {
    npy_intp dims[1];
  ...
  res2center(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14);
...
static PyMethodDef SwigMethods[] = {
	 { "res2center", _wrap_res2center, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
