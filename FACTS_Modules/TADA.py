...
def MakeGestScore(fileName,target_noise, k=5):
    wag_frm = 5;
    ...
    for line in f:
        ...
        if gfileElement[0].strip("''") in TV_index:
            ...
            TV_SCORE = allocateGestScore(TV_SCORE, gfileElement, currentInd, TV_counter[currentInd], n_frm, ms_frm/wag_frm, TV_index,target_noise, k=k)        
        else: 
...
def allocateGestScore(TV_SCORE, gfile, i_TV, nGEST, n_frm, frmratio, index_TV,target_noise, k): 
